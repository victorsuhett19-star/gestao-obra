    ...
    <div className="max-w-2xl rounded-2xl border border-slate-200 bg-surface p-6">
      <ObraForm
        obra={{
          ...
          clienteTelefone: obra.clienteTelefone,
          clienteEmail: obra.clienteEmail,
          clienteCpfCnpj: obra.clienteCpfCnpj,
          descricao: obra.descricao,
          condicoesPagamento: obra.condicoesPagamento,
          prazoExecucaoDias: obra.prazoExecucaoDias,
          status: obra.status,
